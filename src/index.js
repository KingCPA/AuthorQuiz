...
const authors = [
    ...
    imageUrl: 'images/authors/charlesdickins.jpg',
    imageSource: 'Wikimedia Commons',
...
function getTurnData(authors) {
    ...
    const fourRansomBooks = shuffle(allBooks).slice(0,4);
    const answer =sample(fourRansomBooks);

    return {
        books: fourRansomBooks,
